...
| ==, !=, >, <, >=, <= | yes | yes | yes | yes | yes | yes |
| = | yes | yes | yes | yes | yes | yes |
| ?: [[1]](#langext-vector-operations-note-1) | yes | -- | yes | yes | yes | yes |
| sizeof | yes | yes | yes | yes | yes [[2]](#vls) | yes [[2]](#vls) |
...
| address &v[i] | no | no | no [[3]](#langext-vector-operations-note-3) | no | no | no |
...
(langext-vector-operations-note-1)=
**[1]** ternary operator(?:) has different behaviors depending on the condition
...
(vls)=
**[2]** sizeof can only be used on vector length specific SVE and RVV types.

(langext-vector-operations-note-3)=
**[3]** Clang does not allow the address of an element to be taken while GCC
